    ...
    try:
        ...
        for campanha in campanhas:
            ...
            camp_ref.set({
                ...
                "alcance": int(insights.get("reach", 0)),
                "cliques": cliques,
                "cliques_whatsapp": cliques_wpp,
                "ctr": float(insights.get("ctr", 0)),
                "cpc": float(insights.get("cpc", 0)),
                "frequencia": float(insights.get("frequency", 0)),
                ...
                for adset in mc.get_adsets(campanha["id"]):
                    for ad in mc.get_ads(adset["id"]):
                        ...
                        ad_ref.set({
                            ...
                            "impressoes": int(insights_ad.get("impressions", 0)),
                            "alcance": int(insights_ad.get("reach", 0)),
                            ...
                            "frequencia": float(insights_ad.get("frequency", 0)),
